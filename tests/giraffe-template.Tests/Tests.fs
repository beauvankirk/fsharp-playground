...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> giraffe_template.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> giraffe_template.App.configureServices)
